    ...
    return (
        <div className={`mdf__payment-right-banner p-5`}>
            ...
            <Form.Group className="mt-3" controlId="exampleForm.ControlInput56">
                <Form.Control type="email" placeholder="Email*" name="email" className="py-3" onChange={(e) => handleOnChangeFields(e, "email")} value={email} />
        ...
        <label className="w-100">
          ...
          {cardCvcError && (
            ...
            <Form.Group className="mt-3" controlId="exampleForm.ControlInput56">
                <Form.Control type="text" name="cardHolderName" placeholder="Name*" className="py-3" value={cardHolderName} onChange={(e) => handleOnChangeFields(e, "cardHolderName")} />
                {nameError && <span className="error-message">{nameError}</span>}
            </Form.Group>
            <Form.Group className="mt-3" controlId="exampleForm.ControlInput56">
                <Form.Select aria-label="Default select example" name="country" className="form-control py-3" value={country} onChange={(e) => handleOnChangeFields(e, "country")}>
            ...
            <Form.Group className="mt-3" controlId="exampleForm.ControlInput56">
                <Form.Control type="text" name="zipCode" placeholder="Postal Code*" className="py-3" value={zipCode} onChange={(e) => handleOnChangeFields(e, "zipCode")} />
                {zipCodeError && <span className="error-message">{zipCodeError}</span>}
            </Form.Group>

            <Button type="submit" onClick={handleCompleteOrder} className="btn btn-primary mt-3 py-3 px-5 w-100">
                Subscribe
            </Button>
            <p className="text-center text-sm mt-3">After your trial ends, you will be charged US$99.00 per month starting November 18, 2023. You can always cancel before then.</p>
        </div>
    );
}
