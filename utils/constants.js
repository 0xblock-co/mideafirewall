...
export const formElements = [
    ...
    },
    {
        ...
        defaultValues: "",
        validation: yup.string().oneOf(["0", "1", "2", "3"], "Please select a valid option").required("Please select an option"),
    },
    {
        id: 3,
        ...
        defaultValues: "",
        validation: yup.string().oneOf(["0", "1", "2", "3", "4"], "Please select a valid option").required("Please select an option"),
    },
    {
        id: 4,
        name: "features",
