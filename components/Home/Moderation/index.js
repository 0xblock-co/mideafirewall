          ...
          <Col sm={6} className="mt-3 mt-lg-5">
            ...
            <Card className={`p-3 p-lg-5 h-100 ${style.card_custom}`}>
              ...
              <ul className="list-unstyled mt-3 mt-lg-5 mb-0 px-3 px-lg-5">
                ...
                <li className="mb-3">
                  <IoCheckmarkSharp size={24} color="#5E0496" />{" "}
                  <strong>Inconsistent:</strong> Moderation decisions can vary
                  between moderators.{" "}
                </li>
                <li className="mb-3">
                  <IoCheckmarkSharp size={24} color="#5E0496" />{" "}
                  <strong>Limited Scale:</strong> Manual moderation becomes
                  difficult at scale.{" "}
                </li>
                <li className="mb-3">
                  <IoCheckmarkSharp size={24} color="#5E0496" />{" "}
                  <strong>Costly:</strong> It requires dedicated moderators,
                  adding costs.{" "}
                </li>
                <li className="mb-3">
                  <IoCheckmarkSharp size={24} color="#5E0496" />{" "}
                  <strong>Human Error:</strong>Moderators are susceptible to
                  making mistakes.{" "}
                </li>
              </ul>
            </Card>
