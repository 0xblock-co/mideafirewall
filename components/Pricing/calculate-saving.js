                    ...
                    <Col sm={12} className="mt-5">
                        ...
                        <div className="d-flex">
                            <Form.Group className="me-3 mt-3">
                                <Form.Control type="checkbox" className="btn-check" id="btn-check-outlined012" hidden />
                                <label className={`btn btn-outline-primary ${style.checkbox__primary}`} htmlFor="btn-check-outlined012">
                                    0-50
                                </label>
                            </Form.Group>
                            <Form.Group className="me-3 mt-3">
                                <Form.Control type="checkbox" className="btn-check" id="btn-check-outlined02365" hidden />
                                <label className={`btn btn-outline-primary ${style.checkbox__primary}`} htmlFor="btn-check-outlined02365">
                                    50-100
                                </label>
                            </Form.Group>
                            <Form.Group className="me-3 mt-3">
                                <Form.Control type="checkbox" className="btn-check" id="btn-check-outlined036545" hidden />
                                <label className={`btn btn-outline-primary ${style.checkbox__primary}`} htmlFor="btn-check-outlined036545">
                                    100-500
                                </label>
                            </Form.Group>
                            <Form.Group className="me-3 mt-3">
