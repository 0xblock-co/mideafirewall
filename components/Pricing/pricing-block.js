                    ...
                    <Col sm={6} lg={3} xxl={2}>
                        <Card className="mdf__pricingcard card__price__yellow text-center p-3 h-100">
                            <div className="text mb-5 h-100">
                                ...
                                <label className="display-5">$0</label><span>/Month</span>
                                <h4 className="my-4"> 5,000 </h4>
                                <p>operations per month
                                    (max 500 per day)</p>
                                <h4>1</h4>
                                <p>simultaneous video stream</p>
                                <p>Content Moderation</p>
                            </div>
                            <Button variant="primary" className="text-uppercase" size="lg">Get Started</Button>
                        </Card>
                    </Col>
                    <Col sm={6} lg={3} xxl={2}>
                        <Card className="mdf__pricingcard card__price__purple text-center p-3 h-100">
                            <div className="text mb-5 h-100">
                                ...
                                <label className="display-5">$29</label><span>/Month</span>
                                <h4 className="my-4"> 10,000 </h4>
                                <p>operations per month
                                    +$0.02 per additional op</p>
                                <h4>1</h4>
                                <p>simultaneous video stream</p>
                                <p>Content Moderation</p>
                            </div>
                    ...
                    <Col sm={6} lg={3} xxl={2}>
                        <Card className="mdf__pricingcard card__price__orange text-center p-3 h-100">
                            <div className="text mb-5 h-100">
                                ...
                                <label className="display-5">$49</label><span>/Month</span>
                    ...
                    <Col sm={6} lg={3} xxl={2}>
                        <Card className="mdf__pricingcard card__price__red text-center p-3 h-100">
                            <div className="text mb-5 h-100">
                                ...
                                <label className="display-5">$99</label><span>/Month</span>
                    ...
                    <Col sm={6} lg={3} xxl={2}>
                        <Card className="mdf__pricingcard card__price__blue text-center p-3 h-100">
                            <div className="text mb-5 h-100">
                                ...
                                <label className="display-5">$299</label><span>/Month</span>
                                <h4 className="my-4">2,00,000 </h4>
                                <p>operations per month
                                    +$0.0015 per additional op</p>
                                <h4>5</h4>
                                <p>simultaneous video stream</p>
                                <p>Content Moderation</p>
