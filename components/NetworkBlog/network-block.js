            ...
            <Container>
                <Row className="justify-content-center">
                                    ...
                                    <Row>
                                        <Col md={4} xl={3} className="mt-4">
                                                ...
                                                <label class="btn btn-outline-primary card__primary" for="btn-check-outlined012">
                                                    ...
                                                    /></div>
                                                    <Button variant="primary" className="mt-3">Nudity Filter</Button>
                                                    <p className="fw-semibold mt-3">Determine the nudity level, from explicit to mildly suggestive</p>
                    ...
                    <Col md={12} className="text-center">
                        <Button variant="primary" className="shadow-lg px-5 py-2 mt-5 rounded-4">
                        Proceed
                        </Button>
                    </Col>
                </Row>
