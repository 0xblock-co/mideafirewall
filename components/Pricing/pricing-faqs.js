        ...
        <section className={style.mdf__pricing_faqs}>
            <Container>
                ...
                <Row className="justify-content-center">
                    <Col lg={6}>
                        <div className="mt-5">
                            ...
                            <p>
                                An Operation is an atomic action performed by our engine. An atomic action would for instance be running Nudity Detection on 1 image. In this case we would count 1
                                operation. Batches of models count for as many operations as the number of models requested. Each API call that consumes operations will return a specific field to let
                    ...
                    <Col lg={6}>
                        ...
                        <div className="mt-5">
                            ...
                            <p>
                                If you have a set of images that you need to moderate as part of a one-off job, we can come up with a custom solution for you. This is a great way to get started and
                                this is how many customers actually started working with us.
                            </p>
                        </div>
                        <div className="mt-5">
                ...
                <div className="d-flex justify-content-center align-items-center mt-3">
                    ...
                    <div>
                        <Button variant="primary" className="text-uppercase py-3 mx-3" onClick={() => Router.push("/contact-us")}>
                            GET IN TOUCH
                        </Button>
                    </div>
                </div>
